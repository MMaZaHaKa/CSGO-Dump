...
public:
	...
	static void ClantagChanger()
	{
		...
		if (Options.Visuals.Infobox.bClantag)
		{
			...
			switch (value) 
			{
			case 0: SetClanTag("f", "floxware"); break;
			case 1: SetClanTag("fl", "floxware"); break;
			case 2: SetClanTag("flo", "floxware"); break;
			case 3: SetClanTag("flox", "floxware"); break;
			case 4: SetClanTag("floxw", "floxware"); break;
			case 5: SetClanTag("floxwa", "floxware"); break;
			case 6: SetClanTag("floxwar", "floxware"); break;
			case 7: SetClanTag("floxware", "floxware"); break;
			case 8: SetClanTag("floxwar", "floxware"); break;
			case 9: SetClanTag("floxwa", "floxware"); break;
			case 10: SetClanTag("floxw", "floxware"); break;
			case 11: SetClanTag("flox", "floxware"); break;
			case 12: SetClanTag("flo", "floxware"); break;
			case 13: SetClanTag("fo", "floxware"); break;
			case 14: SetClanTag("f", "floxware"); break;
