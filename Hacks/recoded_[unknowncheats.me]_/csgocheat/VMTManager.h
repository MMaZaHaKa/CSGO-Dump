...
{
public:
	char ReadByte(uintptr_t adr) { return *(char*)(adr); }

	short ReadShort(uintptr_t adr) { return *(short*)(adr); }
	void WriteShort(uintptr_t adr, short val) { *(short*)(adr) = val; }
	int ReadInt(uintptr_t adr) { return *(int*)(adr); }
	void WriteInt(uintptr_t adr, int val) { *(int*)(adr) = val; }
	float ReadFloat(uintptr_t adr) { return *(float*)(adr); }
	void WriteByte(uintptr_t adr, char val) { *(char*)(adr) = val; }
	VTHookManager()
	{
		DWORD oProtection;
