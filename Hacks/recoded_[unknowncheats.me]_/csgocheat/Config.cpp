...
void CConfig::Setup()
{
			...
			SetupValue(Options.Ragebot.HvH.bResolver, false, "Rage_Accuracy", "bResolver");
			SetupValue(Options.Ragebot.HvH.ForceAngles, false, "Rage_Accuracy", "ForceAngles");
			SetupValue(Options.Ragebot.HvH.delta2, false, "Rage_Accuracy", "delta2");
			...
			SetupValue(Options.Visuals.Esp.EspBox.Glowmeme2, false, "Rage_Accuracy", "Glow2");

			SetupValue(Options.Visuals.Chams.bFakeAngleChams, false, "Rage_Accuracy", "GhostAngle");
			SetupValue(Options.Visuals.Esp.EspBox.Out, false, "Rage_Accuracy", "aWAYFROMFOV");
			SetupValue(Options.Ragebot.Aimbot.ResolverTest, false, "Rage_Accuracy", "ResolverTest");
			...
			SetupValue(Options.Ragebot.AntiAim.Stand.LBYDELTA, 137, "Edge AA", "MEMEMEMEMEM");
			...
			SetupValue(Options.Visuals.Esp.EspBox.NoSmoke, false, "Visuals_VisualsWorlds", "bNoSmoke");
...
void CConfig::Save()
{
	if (Options.Misc.Movement.Configsss == 0)
	{
		...
		{
			folder = std::string(path) + "\\floxware\\";
			file = std::string(path) + "\\floxware\\config.ini";
		}
	...
	else if (Options.Misc.Movement.Configsss == 1)
	{
		...
		{
			folder = std::string(path) + "\\floxware\\";
			file = std::string(path) + "\\floxware\\config2.ini";
		}
	...
	else if (Options.Misc.Movement.Configsss == 2)
	{
		...
		{
			folder = std::string(path) + "\\floxware\\";
			file = std::string(path) + "\\floxware\\config3.ini";
		}
	...
	else if (Options.Misc.Movement.Configsss == 3)
	{
		...
		{
			folder = std::string(path) + "\\floxware\\";
			file = std::string(path) + "\\floxware\\config4.ini";
		}
	...
	else if (Options.Misc.Movement.Configsss == 4)
	{
		...
		{
			folder = std::string(path) + "\\floxware\\";
			file = std::string(path) + "\\floxware\\config5.ini";
		}
