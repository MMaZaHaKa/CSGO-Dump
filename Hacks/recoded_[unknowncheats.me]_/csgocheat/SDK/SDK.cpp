...
int CBaseEntity::GetSequenceActivity(int sequence)
{
	...
	static auto GetSequenceActivity = reinterpret_cast<int(__fastcall*)(void*, studiohdr_t*, int)>((DWORD)Utils.FindPatternIDA("client.dll", "55 8B EC 83 7D 08 FF 56 8B F1 74 3D"));
